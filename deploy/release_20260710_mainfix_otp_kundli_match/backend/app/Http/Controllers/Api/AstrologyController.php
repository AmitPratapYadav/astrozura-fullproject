...
class AstrologyController extends Controller
{
    ...
    public function getPaidYearlyHoroscope(Request $request)
    {
        ...
        try {
            ...
            $payload = $this->buildBirthPayload($validated['datetime'], $validated['coordinates'], $validated['ayanamsa'] ?? null);
            $chartStyle = (string) ($validated['chart_style'] ?? 'north-indian');
            $varshaphalPayload = array_merge($payload, [
                'year' => $year,
                'varshaphal_year' => $year,
            ]);

            $chartPayload = array_merge($varshaphalPayload, [
            ...
            return response()->json([
                ...
                'data' => [
                    ...
                    'sections' => [[
                        ...
                        'summary' => 'Paid Varshaphal yearly horoscope generated from birth details.',
                        'items' => [
                            'varshaphal_year_chart' => $this->safeAstrologyRequest('varshaphal_year_chart', $chartPayload, $language),
                            'varshaphal_month_chart' => $this->safeAstrologyRequest('varshaphal_month_chart', $chartPayload, $language),
                            'varshaphal_details' => $this->safeAstrologyRequest('varshaphal_details', $varshaphalPayload, $language),
                            'varshaphal_planets' => $this->safeAstrologyRequest('varshaphal_planets', $varshaphalPayload, $language),
                            'varshaphal_muntha' => $this->safeAstrologyRequest('varshaphal_muntha', $varshaphalPayload, $language),
                            'varshaphal_mudda_dasha' => $this->safeAstrologyRequest('varshaphal_mudda_dasha', $varshaphalPayload, $language),
                            'varshaphal_panchavargeeya_bala' => $this->safeAstrologyRequest('varshaphal_panchavargeeya_bala', $varshaphalPayload, $language),
                            'varshaphal_harsha_bala' => $this->safeAstrologyRequest('varshaphal_harsha_bala', $varshaphalPayload, $language),
                            'varshaphal_saham_points' => $this->safeAstrologyRequest('varshaphal_saham_points', $varshaphalPayload, $language),
                            'varshaphal_yoga' => $this->safeAstrologyRequest('varshaphal_yoga', $varshaphalPayload, $language),
                        ],
                    ]],
                ],
            ]);
